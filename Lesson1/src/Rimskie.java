class Rimskie {
    ...
    static String[] rimskie = new String[]{"0", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII", "XIII", "XIV", "XV", "XVI", "XVII", "XVIII", "XIX", "XX", "XXI", "XXII", "XXIII", "XXIV", "XXV", "XXVI",
            ...
            "LXVII", "LXVIII", "LXIX", "LXX", "LXXI", "LXXII", "LXXIII", "LXXIV", "LXXV", "LXXVI", "LXXVII", "LXXVIII", "LXXIX", "LXXX", "LXXXI", "LXXXII", "LXXXIII",
    ...
    public static boolean proverka(String s){
        for (int i = 0; i < rimskie.length ; i++) {
            if(s.equals(rimskie[i]))
                return true;
        }return false;
    }

    public static int rimToArab (String g){
        for (int i = 0; i <rimskie.length ; i++) {
            if(g.equals(rimskie[i]))
                return i;
        }return -1;
    }

    public static String arabToRim(int k){
        return rimskie[k];
    }
}
